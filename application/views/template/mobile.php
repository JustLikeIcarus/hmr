...
$.widget( "mobile.selectmenu", $.mobile.widget, {
	...
	_create: function(){
		...
		var self = this,
			...
			label = $( 'label[for="'+ selectID +'"]' ).addClass( "ui-select" ).hide(),
			...
			button = ( self.options.nativeMenu ? $( "<div/>" ) : $( "<a>", {
				...
				.text(label.text()+' '+ $( select[0].options.item( selectedIndex ) ).text() )
				.insertBefore( select )
				.buttonMarkup({
					theme: o.theme,
					icon: o.icon,
	...
	refresh: function( forceRebuild ){
		...
		self.button
			...
			.text(function(){
				if( !isMultiple ){
					return $('label[for="'+select.attr('id')+'"]').text()+' '+selected.text();
				}
